...
SUMMARY
-------
Total DISCOM Cost: ₹${results.totalActualCost.toLocaleString()}
Proposed OA Cost: ₹${results.totalRecCost.toLocaleString()}
Potential Savings: ₹${results.adjustedSavings.toLocaleString()} (${
      results.savingsPercent
    }%)
Total Units: ${results.totalUnits.toLocaleString()} kWh
...
${results.monthlySummaries
  .map(
    (s) =>
      `${
        s.monthLabel
      }: DISCOM ₹${s.actualCost.toLocaleString()} → OA ₹${s.recCost.toLocaleString()} (Save ₹${s.savings.toLocaleString()})`,
  )
  .join("\n")}
                                ...
                                return (
                                  <div className="bg-popover border border-border rounded-lg p-3 shadow-lg">
                                    ...
                                    <p className="text-xs text-muted-foreground mb-1">
                                      Total: {totalUnits.toLocaleString()} kWh
                                    </p>
                                    <div className="space-y-2 mt-2">
                                      <div>
                                        ...
                                        <div className="flex gap-3 text-xs">
                                          ...
                                          >
                                            DISCOM:{" "}
                                            {data.actualDiscom.toLocaleString()}{" "}
                                            kWh ({actualDiscomPct}%)
                                          </span>
                                          <span
                                            style={{
                                          ...
                                          >
                                            OA: {data.actualOa.toLocaleString()}{" "}
                                            kWh ({actualOaPct}%)
                                          </span>
                                        </div>
                                      </div>
                                              ...
                                              <div className="space-y-1">
                                                ...
                                                {hasOaBill && (
                                                  <div className="flex justify-between gap-4">
                                                    ...
                                                    <span className="font-mono">
                                                      {data?.actualOaUnits?.toLocaleString()}{" "}
                                                      kWh ({oaPercent}%)
                                                    </span>
                                                  </div>
                                                )}
                                                <div className="flex justify-between gap-4">
                                                  ...
                                                  <span className="font-mono">
                                                    {data?.actualDiscomUnits?.toLocaleString()}{" "}
                                                    kWh ({discomPercent}%)
                                                  </span>
                                                </div>
                                            ...
                                            <div className="bg-popover border rounded-lg shadow-lg p-3 text-sm">
                                              ...
                                              <div className="space-y-1">
                                                ...
                                                <div className="flex justify-between gap-4">
                                                  ...
                                                  <span className="font-mono text-success">
                                                    {data?.recommendedOaUnits?.toLocaleString()}{" "}
                                                    kWh ({oaPercent}%)
                                                  </span>
                                                </div>
                                                <div className="flex justify-between gap-4">
                                                  ...
                                                  <span className="font-mono">
                                                    {data?.recommendedDiscomUnits?.toLocaleString()}{" "}
                                                    kWh ({discomPercent}%)
                                                  </span>
                                                </div>
                                                <div className="flex justify-between gap-4 pt-1 border-t">
                                ...
                                {dailyBreakdownTable &&
                                  dailyBreakdownTable.map((day, idx) => (
                                    <TableRow key={idx}>
                                      ...
                                      <TableCell className="text-right text-success">
                                        {day.recommendedOaUnits.toLocaleString()}
                                      </TableCell>
                                      <TableCell className="text-right">
                                        {day.recommendedDiscomUnits.toLocaleString()}
                                      </TableCell>
                                      <TableCell className="text-right">
